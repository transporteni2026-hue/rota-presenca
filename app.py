...
try:
    ...
    # =========================================
        ...
        st.sidebar.markdown("---")
        st.sidebar.caption("Desenvolvido por: MAJ ANDRÉ AGUIAR - 3ª DPJM®️")
    ...
    st.markdown('<div class="footer">Desenvolvido por: <b>MAJ ANDRÉ AGUIAR - 3ª DPJM®️</b></div>', unsafe_allow_html=True)
